...
float moverCuboX = 0.0f;
float moverCuboY = 0.0f;
float moverCuboZ = 0.0f;
float escalarCubo = 1.0f;

float moverCuboX2 = 0.0f;
float moverCuboY2 = 0.0f;
float moverCuboZ2 = 0.0f;
float escalarCubo2 = 1.0f;
...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola Cubo - Natalia Jahnke!", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model2 = glm::translate(model2, glm::vec3(1.1f, 0.0f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(moverCuboX, moverCuboY, moverCuboZ));
		model = glm::scale(model, glm::vec3(escalarCubo));
		model2 = glm::translate(model2, glm::vec3(moverCuboX2, moverCuboY2, moverCuboZ2));
		model2 = glm::scale(model2, glm::vec3(escalarCubo2));
